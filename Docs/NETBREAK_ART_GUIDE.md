...
- **검증 필요:** Unity 화면 적용, 성능, 폰트와 에셋 라이선스.
- **미완료:** 정식 에셋 제작, Unity 적용, 정식 VFX·SFX·BGM.
...
적용 뒤 실제 카메라에서의 크기, 밀집 실루엣, 배경 대비, 도구와 물고기 구분, 픽셀 크기 일관성, 기존 VFX와의 조화, 주요 해상도 가독성과 다수 물고기 성능을 확인한다. 이번 문서 작업에서는 제작·적용하지 않는다.
