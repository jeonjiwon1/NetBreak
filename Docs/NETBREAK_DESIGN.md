...
G6-C2와 임시 전투 피드백 검증 뒤 Area 1의 아트·사운드·온보딩을 갖춘 외부 테스트 가능 버티컬 슬라이스를 준비한다. 현재 Full Run은 최종 수치 확정이 아니라 기능 안정성과 핵심 경험을 확인하기 위한 것이다. 단계별 범위와 통과 기준은 [NETBREAK_ROADMAP.md](NETBREAK_ROADMAP.md)를 따른다.
